                  ...
                  <div class="col-md-8 col-sm-8 mb">
                    <div class="darkblue-panel pn">
                      ...
                      <p><h3>Status - <?= $ticket['status'] ?></h3></p>
                          ...
                          <h5 class="col-xs-6 col-sm-4"><i class="fa fa-trophy"></i> Subject</h5><h5 class="col-xs-4 col-sm-2">______</h5><h5 class="col-xs-6 col-sm-4"><?= $ticket['name'] ?></h5><br>
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                        <?php  if($ticket['status'] == 'open'): ?>
                                          <form role="form" method="POST" action="<?=base_url('replytickets')?>">
                                        ...
                                        <?php else:?>
                                        <form class="centered" role="form" method="POST" action="<?= base_url('changeticket/'.$ticket['id']) ?>">
                                          <div class="form-group">
                                            <h3>Your Ticket has been attended to and it is close</h3><br>
                                          </div>
                                        </form>
                                      <?php endif;?>
                                      </div>
