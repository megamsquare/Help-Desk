...
class UserGroups extends Admin_Controller {
    ...
    public function index() {
        ...
        $data['groups'] = $groups;
        $data['current_page'] = 'usergroup';
        $data['page'] = $this->config->item('ticket_template_dir_admin') . "groups/groups_list";
    ...
    public function create() {
        ...
        $data['current_page'] = 'usergroupcreate';
        $data['page'] = $this->config->item('ticket_template_dir_admin') . "groups/groups_create";
        $this->load->view($this->_container, $data);
    }
    ...
    public function edit($id) {
        ...
        $data['group'] = $group;
        $data['page'] = $this->config->item('ticket_template_dir_admin') . "groups/groups_edit";
        $this->load->view($this->_container, $data);
    }
